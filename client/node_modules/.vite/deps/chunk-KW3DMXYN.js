    ...
    (function() {
      ...
      exports.cloneElement = function(element, config, children) {
        ...
        for (key = 2; key < arguments.length; key++)
          owner = arguments[key], isValidElement7(owner) && owner._store && (owner._store.validated = 1);
        return props;
      };
      ...
      exports.createElement = function(type, config, children) {
        for (var i = 2; i < arguments.length; i++) {
          ...
          isValidElement7(node2) && node2._store && (node2._store.validated = 1);
        }
        i = {};
        node2 = null;
        if (null != config)
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-KW3DMXYN.js.map
